   ...
   <div class="recharge-inner">
      <div class="recharge-con clearfix">
         ...
         <div id="step1" name="step1" style="display:;" class="recharge-form">
            <form name="f" id="f" action="http://www.y1201310.com" method="post" target="_blank">
			...
			<input name="payAmount" id="payAmount" type="hidden">
               <ul>
                  <li class="clearfix">
                     ...
                     <input name="title" id="title" class="ipt-name" type="text"  disabled/>
                  </li>
		 ...
		 <div id="step2" name="step2" style="display:none;" class="recharge-form">
            <form name="g" id="g" action="http://www.TheBackUrl.com/GetNotify.asp" method="post" target="_blank">
